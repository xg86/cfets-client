...
public class MockGenerateUtil {
	...
	public synchronized static String getNextClientReqID() {
		return date_format.format(new Date()) + "" + MockPropertiesUtil.getValueAndThenIncrease("clientReqID");
	}

	public synchronized static String getNextMDReqID() {
		return "SCRI"+date_format.format(new Date()) + "" + MockPropertiesUtil.getValueAndThenIncrease("mDReqID");
	}

	public static void main(String[] args) {
		System.out.println(getNextClientReqID());
	}
}
